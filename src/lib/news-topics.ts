...
export const NEWS_TOPICS: NewsTopic[] = [
  { id: "tech", label: "Technology", keywords: ["technologie", "tech", "software", "app", "startup", "digital"] },
  { id: "ai", label: "AI", keywords: ["ai", "umělá inteligence", "chatgpt", "openai", "llm", "model"] },
  { id: "business", label: "Business", keywords: ["byznys", "business", "ekonomika", "firma", "trh", "invest"] },
  { id: "politics", label: "Politics", keywords: ["politika", "vláda", "volby", "parlament", "senát", "prezident"] },
  { id: "world", label: "World", keywords: ["svět", "zahraničí", "eu", "usa", "ukrajina", "nato"] },
  { id: "science", label: "Science", keywords: ["věda", "science", "výzkum", "studie", "vesmír", "nasa"] },
  { id: "sport", label: "Sport", keywords: ["sport", "fotbal", "hokej", "tenis", "liga", "mistrovství"] },
  { id: "culture", label: "Culture", keywords: ["kultura", "film", "hudba", "seriál", "divadlo", "festival"] },
  { id: "lifestyle", label: "Lifestyle", keywords: ["zdraví", "wellness", "cestování", "recept", "móda", "životní styl"] },
];
